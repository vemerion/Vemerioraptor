...
public class VemerioraptorModel extends EntityModel<VemerioraptorEntity> {
	...
	private void armRotations(ModelRenderer[] arms, float[] armStartRotations, float rotOffset, VemerioraptorEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
